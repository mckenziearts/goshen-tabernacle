    ...
    <div>
        <div class="mt-3 space-y-1">
            ...
            <x-sidebar-link :href="route('admin.events')" :active="request()->routeIs('admin.events*')">
                <svg class="{{ request()->routeIs('admin.events') ? 'text-gray-300': 'text-gray-400 group-hover:text-gray-300' }} mr-3 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
